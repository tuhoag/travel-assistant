...
export function ChatInput({ disabled, onSend }: ChatInputProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="border-t border-zinc-200 px-4 py-4 dark:border-zinc-800">
      <div className="mx-auto flex max-w-5xl items-end gap-2 rounded-3xl border border-zinc-300 bg-white px-4 py-2.5 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
        <textarea
          value={input}
